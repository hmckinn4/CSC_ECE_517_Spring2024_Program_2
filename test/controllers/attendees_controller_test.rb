...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference("Attendee.count") do
      post attendees_url, params: { attendee: { address: @attendee.address, credit_card_info: @attendee.credit_card_info, email: @attendee.email, name: @attendee.name, password: @attendee.password, phone_number: @attendee.phone_number } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { address: @attendee.address, credit_card_info: @attendee.credit_card_info, email: @attendee.email, name: @attendee.name, password: @attendee.password, phone_number: @attendee.phone_number } }
